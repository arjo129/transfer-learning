...
$(document).ready(function ()
{
	...
	var autocomplete = $("#tag_input").easyAutocomplete(options);
	$("#tag_input").change(function(e) {
			...
			<table style="width:100%;background-color:#fff">
				  ...
				  <tr>
					...
					<td id="col3" style="white-space: nowrap;padding-left:30px;width:350px;max-width:400px;background-color:#fff">
							...
							-->
							<div style="padding-top:200px;box-sizing: border-box;width=100%;text-align: right;">
